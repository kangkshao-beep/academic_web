...
export default function SiteTrafficWidget() {
  ...
  useEffect(() => {
    // Wait for the router to resolve the pathname so the initial render does
    // not accidentally record a view against the public root.
    if (!pageKey) {
      setStats(null);
      return;
    }
